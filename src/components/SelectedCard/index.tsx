...
import {ContentWrapper, FilmDescription, FilmGenre, FilmLength, FilmRating, FilmTitle, ImageBigWrapper, InfoWrapper,
    SelectedWrapper} from "./style";
        ...
        <SelectedWrapper>
            <ImageBigWrapper><img src={e.posterUrl} alt={e.nameRu}/></ImageBigWrapper>
                <ContentWrapper>
                    ...
                    <InfoWrapper>
                        <FilmRating rating={e.ratingKinopoisk}>{e.ratingKinopoisk}</FilmRating>
